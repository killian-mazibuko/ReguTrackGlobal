...
def test_chat(sized_page: Page, live_server_url: str):
    ...
    page.get_by_placeholder("ReguTrack Globalquestion (e.g. how is personal information protected in South Africa in South Africa?) (e.g. does my plan cover annual eye exams?)").click()
    page.get_by_placeholder("Type a new question (e.g. how is personal information protected in South Africa?)").fill(
...
def test_chat_stop_button_visibility(page: Page, live_server_url: str):
    ...
    # Ask a question
    page.get_by_placeholder("Type a new question (e.g. how is personal information protected in South Africa?)").click()
    page.get_by_placeholder("Type a new question (e.g. how is personal information protected in South Africa?)").fill(
        "Whats the dental plan?"
    )
...
def test_chat_stop_restores_question(page: Page, live_server_url: str):
    ...
    # Type a question
    question_input = page.get_by_placeholder("Type a new question (e.g. how is personal information protected in South Africa?)")
